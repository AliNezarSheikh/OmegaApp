...
class setshipping extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: PrimaryText(words: "Set Shipping Address"),
      ),
      body: FutureBuilder(
                                    ...
                                    return AnimationConfiguration.staggeredList(
                                      ...
                                      child: SlideAnimation(
                                        ...
                                        child: FlipAnimation(duration: Duration(milliseconds: 3000), curve: Curves.fastLinearToSlowEaseIn, flipAxis: FlipAxis.y,
                                            child: adresslistshipping(listadress[index], controller,context,)),
                                      ),
                                    );
                                  }),
                            ),
                              ...
                              child: Obx(
                                  ...
                                  builder: (BuildContext context) {
                                    return  buildsmallButton(
                                        ...
                                        buttoncolor:fontcolorprimary,
                                        onTap: () async {
                                          if(controller.setshippingaddress.value.id != null){
                                              await dashcontrol.setbillingandshippingaddress(
                                                  ...
                                                  address1shi: controller.setshippingaddress.value.address1!,
                                                  cityshi: controller.setshippingaddress.value.city! ,
                                                  emailshi:  currentuser!.email!,
                                                  first_nameshi: controller.setshippingaddress.value.firstname! ,
                                                  idshi: controller.setshippingaddress.value.id!,
                                                  last_nameshi: controller.setshippingaddress.value.lastname!,
                                                  phoneaddressshi: controller.setshippingaddress.value.phoneaddress!,
                                                  state_nameshi: controller.setshippingaddress.value.state!,
                                                  context: context,
                                                  token: token!);
