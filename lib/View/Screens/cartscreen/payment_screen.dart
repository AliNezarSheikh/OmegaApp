                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Spacer(),
                        PrimaryText(
                            words: "${currentcart!.formatted_grand_total}")
                      ],
                    ),
                  ),
                  buildButton(
                      ...
                      onTap: () async {
                        if (controller.setpaymethod.value != "") {
                          await controller.setmethodpayment(
                              token: token!,
                              context: context,
                              method: controller.setpaymethod.value);
                          ...
                          showresult(
                              context, Colors.red, "Select Payment Method");
                        }
                      }),
                ],
              )),
